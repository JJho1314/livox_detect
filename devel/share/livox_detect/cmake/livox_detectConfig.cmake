...
if("TRUE" STREQUAL "TRUE")
  set(livox_detect_SOURCE_PREFIX /media/workspace/livox_detect/src/livox_detect)
  set(livox_detect_DEVEL_PREFIX /media/workspace/livox_detect/devel)
  ...
  set(livox_detect_INSTALL_PREFIX /media/workspace/livox_detect/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'livox_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/workspace/livox_detect/src/livox_detect/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/workspace/livox_detect/devel/lib;/opt/ros/melodic/lib)
